...
public class SocketHandler implements WebSocketHandler {
  ...
  @Autowired private WebSocketMessagePublisher webSocketMessagePublisher;
  ...
  public SocketHandler(UnicastProcessor<TickerChannel> eventPublisher, Flux<TickerChannel> events) {
  ...
  public SocketHandler getSocketHandler() {
    this.webSocketMessagePublisher = new WebSocketMessagePublisherImpl(this.eventPublisher);
    return this;
  }
