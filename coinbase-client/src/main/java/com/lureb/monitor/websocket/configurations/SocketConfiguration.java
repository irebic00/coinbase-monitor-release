 ...
 *
 * <p>TODO: Add more configuration params to client and this app (backpressure, buffer probably
 * TODO: breaks on client side). So check {@link com.lureb.monitor.Application#events}
 *
 * <p>TODO: Remove all this and store to db.
 *
 * @author ivan
 */
public class SocketConfiguration {
  ...
  public SubscriptionResponse createSubscription(Subscription subscription) {
    ...
    if (subscriptionConfiguration.getSubscriptions().contains(subscription)) {
      return new SubscriptionResponse(uuid, SubscriptionResponse.Status.ALREADY_EXISTS);
    }
